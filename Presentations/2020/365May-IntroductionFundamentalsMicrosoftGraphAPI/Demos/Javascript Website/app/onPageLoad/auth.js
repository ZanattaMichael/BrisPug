...
//
// Step 1. We create a new Microsoft Authentication library Object
//
...
//
// Step 2: We register a callback for when the Token
...
myMSALObj.handleRedirectPromise().then((tokenResponse) => {
    ...
    // If a Token was returned or an existing token has been created
...
//
// Step 3, register a custom function to login!
//
...
async function signIn(method) {
    ...
    if (signInType === "loginPopup") {
        ...
        //
        // Step 4: Profit! Once the object has been setup,
        // we call .loginPopup(loginRequest) method!
        // This will handle our OAuthToken for us!
        //
        // const loginRequest = {
        //     scopes: ["User.Read"]
        // };
